<html>
  ...
  <head>
    <title> Manager Signup | Burger Shack </title>
	<style>
	   body {
  ...
  <body>
  <a href="home.php"><img class="top_herder_logo" src="logo.png" width="94" height="95" alt="logo" id="logo" align="left"></a>

  

    <div class="container">
    <div class="jumbotron">
     <h1>Hi Manager, <br> Welcome to <span class="edit"> Burger Shack </span></h1>
     <br>
  ...
  <br><br><br>
  <p> Burger Shack 2020 | &copy All Rights Reserved </p>
